...
//Recipes getter
Recipes.create('cereal', ['selected cereal' , 'milk', 'spoon, bowl'] );
Recipes.create('hopes', ['saddness', 'frustration']);
Recipes.create('dreams', ['more saddness', '80 hour work weeks', 'tears']);
